...
decision = raw_input("Would you like to use pounds(l) or grams(g): ")
print()
pennyAmount = float(raw_input("How much do the pennies weigh: "))
coinPenny(pennyAmount,decision)
print()
nickelAmount = float(raw_input("How much do the nickels weigh: "))
coinNickel(nickelAmount,decision)
print()
dimeAmount = float(raw_input("How much do the dimes weigh: "))
coinDime(dimeAmount,decision)
print()
quarterAmount = float(raw_input("How much do the quarters weigh: "))
